...
export const WhenPlayedCases = {
  "When Played: U-Wing Many Played": async function () {
    ...
    await browser
      ...
      .pause(p.CheckBox)
      .click(com.Checkbox(5))
      .pause(p.CheckBox)
      .click(com.Checkbox(8))
      .pause(p.CheckBox)
  ...
  "When Played: Leia JTL lets Pilot attack": async function () {
    ...
    await gameState
      ...
      .AddUnit(1, cards.JTL.XWing, true, 1, new SubcardBuilder().AddUpgrade(cards.JTL.Chewbacca, 1, true).Build())
