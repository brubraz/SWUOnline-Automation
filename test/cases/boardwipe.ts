...
export const BoardWipeCases = {
  ...
  "Iden Versio Leader Unit SLB Two Idens":
  ...
  "Iden Versio Leader Unit Christophsis Two Idens":
    process.env.FULL_REGRESSION !== "true"
      ? ""
      : async function () {
          //arrange
  ...
  "Gideon Hask gives XP to rescued captive": async function () {
    ...
    await gameState
      ...
      .AddUnit(2, cards.SOR.DSStormTrooper)
      .AddUnit(2, cards.SOR.TieLnFighter, true, 0, new SubcardBuilder().AddCaptive(cards.SOR.CraftySmuggler, 1).Build())
      .AddUnit(2, cards.SOR.AdmiralAckbar, true, 0, new SubcardBuilder().AddUpgrade(cards.SHD.TopTarget, 1).Build())
      .FlushAsync(com.BeginTestCallback);
    //act
    await browser
      .waitForElementPresent(com.MyHand)
  ...
  "Two Gideon Hasks give XP to rescued captives": async function () {
    ...
    await gameState
      ...
      .AddUnit(1, cards.SOR.DSStormTrooper)
      .AddUnit(1, cards.SOR.GideonHask)
      .AddUnit(1, cards.SOR.DarthVader, true, 0, new SubcardBuilder().AddCaptive(cards.SOR.BFMarine, 2).Build())
      .AddUnit(2, cards.SOR.DSStormTrooper)
      .AddUnit(2, cards.SOR.TieLnFighter, true, 0, new SubcardBuilder().AddCaptive(cards.SOR.CraftySmuggler, 1).Build())
      .AddUnit(2, cards.SOR.AdmiralAckbar, true, 0, new SubcardBuilder().AddUpgrade(cards.SHD.TopTarget, 1).Build())
