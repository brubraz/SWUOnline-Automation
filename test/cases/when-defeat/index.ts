...
export const WhenDefeatCases = {
    'When Defeat: SLT w Clone Cohort Pinged by Dengar': process.env.SKIP_FULL_REGRESSION ? '' : async function () {
    ...
    'When Defeat: Gar Saxon Upgrade Bounce': process.env.SKIP_FULL_REGRESSION ? '' : async function () {
