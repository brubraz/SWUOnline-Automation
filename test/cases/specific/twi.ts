...
import { com, p, player1Window, player2Window, customAsserts, src, gameName } from "../../utils/util";
...
export const SpecificTWICases = {
  "Exploit: Red Dooku TWI and triggers":
    process.env.FULL_REGRESSION !== "true"
      ...
      : async function () {
          ...
          await browser
            ...
            .click(com.Checkbox(1))
            .pause(p.CheckBox)
            .click(com.Checkbox(2))
            .pause(p.CheckBox)
            .click(com.SubmitButton)
            .pause(p.ButtonPress)
            .moveToElement(com.GameChat, 0, 0)
  ...
  "On Attack: Darth Maul TWI single target available":
    process.env.FULL_REGRESSION !== "true"
      ? ""
      : async function () {
          //arrange
  ...
  "On Attack: Darth Maul TWI single target choice":
    process.env.FULL_REGRESSION !== "true"
      ? ""
      : async function () {
          //arrange
  ...
  "On Attack: Darth Maul TWI sentinels":
    process.env.FULL_REGRESSION !== "true"
      ? ""
      : async function () {
          //arrange
  ...
  "On Attack: Darth Maul TWI single sentinel":
    process.env.FULL_REGRESSION !== "true"
      ? ""
      : async function () {
          //arrange
  ...
  "Shadowed Intentions: avoids enemy capture":
    process.env.FULL_REGRESSION !== "true"
      ? ""
      : async function () {
          //arrange
  ...
  "Shadowed Intentions: enemy damage":
    process.env.FULL_REGRESSION !== "true"
      ? ""
      : async function () {
          //arrange
  ...
  "Shadowed Intentions: defeats (merciless contest)":
    process.env.FULL_REGRESSION !== "true"
      ? ""
      : async function () {
          //arrange
  ...
  "Shadowed Intentions: damaged by self":
    process.env.FULL_REGRESSION !== "true"
      ? ""
      : async function () {
          //arrange
  ...
  "Shadowed Intentions: bounced by enemy":
    process.env.FULL_REGRESSION !== "true"
      ? ""
      : async function () {
          //arrange
  ...
  "Shadowed Intentions: bounced by self":
    process.env.FULL_REGRESSION !== "true"
      ? ""
      : async function () {
          //arrange
