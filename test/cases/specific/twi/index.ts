...
export const SpecificTWICases = {
  ...
  'On Attack: Maul TWI single target choice': process.env.FULL_REGRESSION !== "true" ? '' : async function () {
  ...
  'On Attack: Maul TWI sentinels': process.env.FULL_REGRESSION !== "true" ? '' : async function () {
